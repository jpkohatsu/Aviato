...
// $(document).ready(function() {
//   // $(".myJobsPage").html("Test");
//   var jobsSelected = JSON.parse(localStorage.getItem("lastClicked"));
//   console.log(jobsSelected);
//   // console.log(jobArray);
//   // console.log("job array length" + jobArray.length);
//   // console.log("job array [0]" + jobArray[0]);
// //   for (var i = 0; i < jobArray.length; i++) {
// //
//       $(".myJobsPage").append(jobsSelected);
// // }
//
//
//
